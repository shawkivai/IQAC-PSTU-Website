...
<head>
	<meta charset="utf-8">
	<title>CSE PSTU Admin panel</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="CSE PSTU Teacher, Teacher Change password">
			...
			<div class="row-fluid">
				<div class="well span5 center login-box">
					<div class="alert alert-info">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url();?>super_admin/check_password" method="post">
						<fieldset>
							<div class="input-prepend" title="Enter Old Password" data-rel="tooltip">
								<span class="add-on"><i class="icon-lock"></i></span><input autofocus class="input-large span10" name="admin_old_password" placeholder="Old Password" id="username" type="password"  />
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Enter New Password" data-rel="tooltip">
                                                            <span class="add-on"><i class="icon-lock"></i></span><input class="input-large span10" name="admin_new_password" placeholder="New Password" id="password" type="password"  />
							</div>
							<div class="clearfix"></div>

...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url();?>super_admin/save_files" method="post">
                <fieldset>
                    <legend></legend>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="typeahead">News Short Description  </label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="typeahead">News Long Description  </label>
                        <div class="controls">

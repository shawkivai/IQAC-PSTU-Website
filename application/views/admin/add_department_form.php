...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="<?php echo base_url();?>super_admin/save_department" method="post">
                <fieldset>
                    <legend></legend>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea name="department_description" class="cleditor" id="textarea2" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="control-group">

...
<head>
	<meta charset="utf-8">
	<title>IQAC-PSTU Admin panel</title>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="span12 center login-header">
					<h2>Welcome to IQAC-PSTU Admin Login</h2>
				</div><!--/span-->
			</div><!--/row-->
					...
					<div class="alert alert-info">
						...
						<fieldset>
							...
							<div class="input-prepend" title="Password" data-rel="tooltip">
								<span class="add-on"><i class="icon-lock"></i></span><input class="input-large span10" name="admin_password" placeholder="Password" id="pwd" type="password" />
                                                                <button type="button" id="eye"><img src="https://cdn0.iconfinder.com/data/icons/feather/96/eye-16.png" alt="eye" />
</button>

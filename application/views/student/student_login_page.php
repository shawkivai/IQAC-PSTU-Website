...
<head>
	...
	<meta name="description" content="Faculty of computer Science and Engineering">
			...
			<div class="row-fluid">
				<div class="well span5 center login-box">
					<div class="alert alert-info">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url();?>student_login/check_student_login" method="post">
						<fieldset>
							<div class="input-prepend" title="Registration No" data-rel="tooltip">
								<span class="add-on"><i class="icon-user"></i></span><input autofocus class="input-large span10" name="student_reg_no" placeholder="Registration No." id="username" type="text"  />
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password" data-rel="tooltip">
								<span class="add-on"><i class="icon-lock"></i></span><input class="input-large span10" name="student_password" placeholder="Password" id="password" type="password" />
							</div>
							<div class="clearfix"></div>

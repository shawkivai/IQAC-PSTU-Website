			...
			<div class="row-fluid">
				<div class="well span5 center login-box">
					<div class="alert alert-info">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url();?>forgot_password/change_password" method="post">
						<fieldset>
							<div class="input-prepend" title="Give New Password" data-rel="tooltip">
								<span class="add-on"><i class="icon-user"></i></span><input autofocus class="input-large span10" name="password" id="username" type="text"  />
							</div>

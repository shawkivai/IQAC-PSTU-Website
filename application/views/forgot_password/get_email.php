			...
			<div class="row-fluid">
				<div class="well span5 center login-box">
					<div class="alert alert-info">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url();?>forgot_password/check_teacher_email" method="post">
						<fieldset>
							<div class="input-prepend" title="Email ID" data-rel="tooltip">
								<span class="add-on"><i class="icon-user"></i></span><input autofocus class="input-large span10" name="teacher_email" id="username" type="text"  />
							</div>
							...
							<button type="submit" class="btn btn-primary">Submit</button>
                                                                  ...
                                                                  <p class="center span5">
							<a href="<?php echo base_url();?>welcome/report_admin" ><font color="#000" size="2px" > Report to Admin</font></a>

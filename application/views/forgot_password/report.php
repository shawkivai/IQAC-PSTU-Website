			...
			<div class="row-fluid">
				<div class="well span5 center login-box">
					<div class="alert alert-info">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url();?>forgot_password/check_security_question" method="post">
						<fieldset>
                                                                                                                        
							<h4>Hello, <?php echo $this->session->userdata('teacher_name');?> Sir</h4>
                                                                                             <h3 style="color: green"><?php echo $this->session->userdata('security_question');?></h3>
                                                                                            
							<div class="clearfix"></div>
                                                                                            
							<div class="input-prepend" title="answer" data-rel="tooltip">
								<span class="add-on"><i class="icon-lock"></i></span><input class="input-large span10" name="answer" id="password" type="password" />
							</div>
							<div class="clearfix"></div>
							...
							<button type="submit" class="btn btn-primary">Submit</button>
                                                                                         ...
                                                                                         <p class="center span5">
							<a href="<?php echo base_url();?>welcome/report_admin" ><font color="#000" size="2px" >Can't Remember Security Question? Report to Admin</font></a>

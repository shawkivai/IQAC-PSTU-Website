...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="<?php echo base_url();?>super_teacher/save_blog" method="post" onsubmit="return validateStandard(this)">
                <fieldset>
                    <legend></legend>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="textarea2">Full Description</label>
                        <div class="controls">
                            <textarea name="blog_description" class="cleditor" id="textarea2" rows="3"></textarea>
                        </div>
                    </div>

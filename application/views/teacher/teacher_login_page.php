			...
			<div class="row-fluid">
				<div class="well span5 center login-box">
					<div class="alert alert-info">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url();?>teacher_login/check_teacher_login" method="post">
						<fieldset>
							<div class="input-prepend" title="Email" data-rel="tooltip">
								<span class="add-on"><i class="icon-user"></i></span><input autofocus class="input-large span10" name="teacher_email" placeholder="Email" id="username" type="text"  />
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password" data-rel="tooltip">
								<span class="add-on"><i class="icon-lock"></i></span><input class="input-large span10" name="teacher_password" placeholder="Password" id="password" type="password" />
							</div>
							<div class="clearfix"></div>
					...
					<p class="center span5">
							<a href="<?php echo base_url();?>forgot_password" ><font color="#000" size="2px" >Forgot Password?</font></a>
							</p>

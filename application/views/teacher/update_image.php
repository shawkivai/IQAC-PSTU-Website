...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form name="upload_image" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>super_student/update_teacher_image" method="post">
                <fieldset>
                    <legend></legend>
...
<input type="hidden" class="span6 typeahead" id="typeahead"  name="teacher_id" value="<?php echo $teacher_info->teacher_id; ?>">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Image   (Max Size: 500 KB ) </label>
                        <div class="controls">
                            <input type="file" class="span6"   name="teacher_image" value="">
